...
class GameController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Create a new game
        Game::create($request->only(['home_team_id', 'away_team_id', 'game_time', 'location', 'score_home', 'score_away']));
    ...
    public function update(Request $request, $id)
    {
        ...
        // Update the game
        $game->update($request->only(['home_team_id', 'away_team_id', 'game_time', 'location', 'score_home', 'score_away']));
